...
STARTING A NEW LANGUAGE FOCUS GROUP

1. Find Language Captain
2. Create Telegram group and convert it to Super Group
3. Convert the invite link to something logical (currently we are using the ISO keyboard list for the URL) https://www.loc.gov/standards/iso639-2/php/code_list.php
4. Add the Language Captain as admin of group
5. Remove the option, if checked, where users can delete the group and other members

6. Have the Language Captain translate the following into their own language:
    
    The UBports Community is excited to annouce a brand new language group: 
        
        ==================================

[langauge name in their own font] | KOREAN


Do you speak Korean?  Join the UBports Korean language group!
...
7. Alert Wayne (@wayneoutthere) when complete and he will create a logo for the group photo.  Provide Wayne all of the information here
